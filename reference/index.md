...
- [`exact_beta_poisson_response()`](https://seanthimons.github.io/singlehit/reference/exact_beta_poisson_response.md)
  : Exact beta-Poisson dose-response function
- [`exact_beta_poisson_survival()`](https://seanthimons.github.io/singlehit/reference/exact_beta_poisson_survival.md)
...
- [`prediction_curve()`](https://seanthimons.github.io/singlehit/reference/prediction_curve.md)
...
- [`bootstrap_dose_response_async()`](https://seanthimons.github.io/singlehit/reference/bootstrap_dose_response_async.md)
  : Start a non-blocking dose-response bootstrap
- [`bootstrap_dose_response_models()`](https://seanthimons.github.io/singlehit/reference/bootstrap_dose_response_models.md)
...
- [`bootstrap_confint()`](https://seanthimons.github.io/singlehit/reference/bootstrap_confint.md)
  : Bootstrap percentile confidence intervals

## broom / tidymodels methods

- [`tidy(`*`<qdr_fit>`*`)`](https://seanthimons.github.io/singlehit/reference/tidy.qdr_fit.md)
...
- [`augment(`*`<qdr_fit>`*`)`](https://seanthimons.github.io/singlehit/reference/augment.qdr_fit.md)
...
- [`ward_rotavirus`](https://seanthimons.github.io/singlehit/reference/ward_rotavirus.md)
